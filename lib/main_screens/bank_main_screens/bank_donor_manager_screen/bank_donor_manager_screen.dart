...
import 'package:blood_link/main_screens/bank_main_screens/bank_donor_manager_screen/view_donor.dart';
...
class BankDonorManagerScreen extends StatefulWidget {
  const BankDonorManagerScreen({super.key});
  static String id = "/bank_donor_manager_screen";
  @override
  State<BankDonorManagerScreen> createState() => _BankDonorManagerScreenState();
}

class _BankDonorManagerScreenState extends State<BankDonorManagerScreen> {
